  ...
  return (
    <div className="bg-white text-black p-6 max-w-2xl mx-auto" id="paystub-printable">
      ...
      <p className="text-[10px] text-gray-500 mt-6 text-center italic">
        Estimated payroll for internal operational use only. Not a licensed payroll service.
        Not tax advice. Withholdings are simplified flat rates, not IRS tax tables. Does not
        replace W-2, 1099, or Form 941. Consult a CPA or licensed payroll provider for filing.
      </p>
    </div>
  );
}
