...
export async function generatePaystubPdf({ line, organizationName, periodLabel }: Args): Promise<void> {
  ...
  const disclaimer =
    "Estimated payroll for internal operational use only. Not a licensed payroll service. Not tax advice. Withholdings are simplified flat rates, not IRS tax tables. Does not replace W-2, 1099, or Form 941. Consult a CPA or licensed payroll provider for filing.";
