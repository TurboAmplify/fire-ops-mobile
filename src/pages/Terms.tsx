    ...
    <AppShell title="Terms of Use">
      <div className="p-4 space-y-4">
        ...
        <div className="rounded-xl bg-card p-4 space-y-4 text-sm leading-relaxed text-muted-foreground">
          ...
          <h3 className="text-foreground font-semibold pt-2">Payroll & Tax Estimation</h3>
          <p>
            FireOps HQ includes an optional payroll module that calculates gross pay,
            withholdings, deductions, and generates paystub PDFs. <strong className="text-foreground">
            This module is an operational estimation tool only.</strong> It is not a licensed
            payroll service, not a tax preparation service, and not tax advice.
          </p>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              Withholding percentages are simplified flat rates configured by your
              organization. They are <strong className="text-foreground">not</strong> derived
              from IRS tax tables, Publication 15-T, or any state taxing authority's tables.
            </li>
            <li>
              Paystubs generated by the App do <strong className="text-foreground">not</strong>{" "}
              replace W-2s, 1099s, Form 941, state filings, or any official tax document.
            </li>
            <li>
              You remain solely responsible for filing taxes, remitting withholdings, and
              complying with all federal, state, and local payroll laws — through a qualified
              CPA, licensed payroll provider, or comparable professional.
            </li>
            <li>
              FireOps HQ, its operators, and its developers are <strong className="text-foreground">
              not liable</strong> for any underpayment, overpayment, penalty, interest, audit
              finding, or filing error arising from use of the payroll estimates.
            </li>
          </ul>
