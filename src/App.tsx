...
const SettingsTrash = lazyWithRetry(() => import("./pages/SettingsTrash"));

const IncidentCreate = lazyWithRetry(() => import("./pages/IncidentCreate"));
const IncidentFromAgreement = lazyWithRetry(() => import("./pages/IncidentFromAgreement"));
const IncidentEdit = lazyWithRetry(() => import("./pages/IncidentEdit"));
const ShiftTicketCreate = lazyWithRetry(() => import("./pages/ShiftTicketCreate"));
const ShiftTicketEdit = lazyWithRetry(() => import("./pages/ShiftTicketEdit"));
const ShiftTicketLog = lazyWithRetry(() => import("./pages/ShiftTicketLog"));
const Crew = lazyWithRetry(() => import("./pages/Crew"));
const Crews = lazyWithRetry(() => import("./pages/Crews"));
const CrewDetail = lazyWithRetry(() => import("./pages/CrewDetail"));
const Fleet = lazyWithRetry(() => import("./pages/Fleet"));
const FleetTruckCreate = lazyWithRetry(() => import("./pages/FleetTruckCreate"));
const FleetTruckDetail = lazyWithRetry(() => import("./pages/FleetTruckDetail"));
const FleetTruckEdit = lazyWithRetry(() => import("./pages/FleetTruckEdit"));
const FleetTruckRates = lazyWithRetry(() => import("./pages/FleetTruckRates"));
const Expenses = lazyWithRetry(() => import("./pages/Expenses"));
const ExpenseEdit = lazyWithRetry(() => import("./pages/ExpenseEdit"));
const ExpenseDetail = lazyWithRetry(() => import("./pages/ExpenseDetail"));
const ExpenseReview = lazyWithRetry(() => import("./pages/ExpenseReview"));
const BatchReceiptScan = lazyWithRetry(() => import("./pages/BatchReceiptScan"));
...
const SuperAdminOrgs = lazyWithRetry(() => import("./pages/SuperAdminOrgs"));
const SuperAdminOrgDetail = lazyWithRetry(() => import("./pages/SuperAdminOrgDetail"));
const SuperAdminUsers = lazyWithRetry(() => import("./pages/SuperAdminUsers"));
const SuperAdminActivity = lazyWithRetry(() => import("./pages/SuperAdminActivity"));
const SuperAdminAudit = lazyWithRetry(() => import("./pages/SuperAdminAudit"));
const SuperAdminErrors = lazyWithRetry(() => import("./pages/SuperAdminErrors"));
