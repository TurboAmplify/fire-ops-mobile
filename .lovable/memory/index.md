...
- [OF-297 Shift Tickets](mem://features/of297-shift-tickets) — Shift ticket form, signatures, PDF export, linked to incident_trucks
- [No emojis](mem://constraint/no-emojis) — Never use emoji characters in the UI
